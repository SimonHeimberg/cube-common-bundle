...
{
    /**
     * @var int number of digits for digital part
     */
    protected $integerPartLength = 4;

    /**
     * @var int number of digits for float part
     */
    protected $floatPartLength = 3;

    /**
     * @var int maximum number of chars allowed in string for natural sorting (0 - unlimited)
     */
     ...
     *
     * @param int $integerPartLength number of digits for digital part
     *
     ...
     *
     * @param int $floatPartLength number of digits for float part
     *
     * @return NaturalSorting object, on which this method was executed
     */
     ...
     *
     * @param int $naturalSortingValueMaximalLength maximum number of chars allowed in string for natural sorting (0 - unlimited)
     *
     * @return NaturalSorting object, on which this method was executed
     */
    ...
    public function getValueForNaturalSorting($valueForSorting)
    {
        $output = preg_replace_callback(
                '/\d+(\.\d+)?/',
                array($this, 'naturalSortingCallback'),
                $valueForSorting
            );
